...
$R_{Y} R_{X} R_{Z} = \begin{bmatrix}
 cos_y cos_z + sin_y sin_x sin_z & cos_z sin_y sin_x - cos_y sin_z &   cos_x sin_y \\
  cos_x sin_z & cos_x cos_z & - sin_x \\
 cos_y sin_x sin_z - cos_z sin_y & cos_y cos_z sin_x + sin_y sin_z & cos_y cos_x 
\end{bmatrix}
