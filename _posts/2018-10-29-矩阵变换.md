...
$tan_z = \frac{sin_z}{cos_z} = \frac{cos_x sin_z}{cos_x cos_z} = \frac{2(qx*qy+w*qz)}{1-2(qz^2+qx^2)}$


$tan_y = \frac{sin_y}{cos_y} = \frac{cos_x sin_y}{cos_y cos_z} = \frac{2(qy*w+qz*qx)}{1-2(qy^2+qx^2)}$
