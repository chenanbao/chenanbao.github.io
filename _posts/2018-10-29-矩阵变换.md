...
$
\begin{bmatrix}
\color{Red}x' & \color{Red}y' & \color{Red}z' & \color{Red}1\\
\end{bmatrix}=\begin{bmatrix}
\color{Red}x & \color{Red}y & \color{Red}z & \color{Red}1\\
\end{bmatrix}R_{x}(\theta_{x})
 =\begin{bmatrix}
\color{Red}x & \color{Red}y & \color{Red}z & \color{Red}1\\
\end{bmatrix}\begin{bmatrix}
\color{Blue}1 & \color{Blue}0 & \color{Blue}0 & \color{Blue}0 \\ 
\color{Blue}0 & cos\theta & sin\theta & 0 \\ 
\color{Blue}0 & -sin\theta & cos\theta &0 \\ 
\color{Blue}0 & 0 & 0 & 1
\end{bmatrix}$
...
\end{bmatrix}=\begin{bmatrix}
\color{Red}x & \color{Red}y & \color{Red}z & \color{Red}1\\
\end{bmatrix}R_{y}(\theta_{y})
 =\begin{bmatrix}
\color{Red}x & \color{Red}y & \color{Red}z & \color{Red}1\\
\end{bmatrix}\begin{bmatrix}
cos\theta & \color{Blue}0 & -sin\theta & 0 \\ 
\color{Blue}0 & \color{Blue}1 & \color{Blue}0 & \color{Blue}0 \\ 
sin\theta & \color{Blue}0 & cos\theta &0 \\ 
0 & \color{Blue}0 & 0 & 1
\end{bmatrix}$
...
矩阵计算如下图，对比上面右手坐标系绕z轴逆时针旋转矩阵，实际是同一个矩阵，只是这个用的行向量左乘的旋转矩阵。
...
在Unity中从左向右依次为,绕x轴逆时针旋转，绕y轴逆时针旋转，绕z轴顺时针旋转。
