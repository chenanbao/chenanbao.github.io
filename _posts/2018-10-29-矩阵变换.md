...
A为n阶矩阵，|A|是A的行列式(注意不是绝对值,也不是向量求模)，又记为detA。A*是指矩阵A的伴随矩阵，是由A的元素的代数余子式按照交换行列标的顺序构成的同级矩阵。其几何意义参见[向量叉乘](https://chenanbao.github.io/2018/10/26/%E5%B8%B8%E8%A7%81%E6%95%B0%E5%AD%A6%E5%85%AC%E5%BC%8F%E6%8E%A8%E5%AF%BC/)
