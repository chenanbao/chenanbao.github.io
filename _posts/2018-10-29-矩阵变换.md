...
+ 外旋（extrinsic rotation）:绕惯性坐标系upright-space 旋转（upright space指基向量平行于world-space或parent-space，原点与object-space的原点重合的空间）。 无论是三步旋转中的哪一步，轴都是固定的，是不会动的。
...
**unity中的rotation就是一种外旋，是以惯性坐标系为轴的。Unity欧拉角使用zxy(roll - pitch - yaw)的顺规。**
