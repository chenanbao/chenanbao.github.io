...
$q = q_{y}(\theta)q_{x}(\phi)q_{z}(\psi) =  \left[\begin{matrix} 0  \\ sin(\theta /2)  \\ 0  \\  cos(\theta /2)  \end{matrix}\right]\left[\begin{matrix}  sin(\phi /2) \\ 0  \\ 0  \\ cos(\phi  /2)  
 \end{matrix}\right]\left[\begin{matrix}   0  \\ sin(\psi  /2)  \\ 0  \\ cos( \psi  /2)  \end{matrix}\right]$
