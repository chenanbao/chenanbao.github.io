...
\frac{x_{p}-l}{r-l}=\frac{x_{ndc}-(-1)}{1-(-1)} \Rightarrow  x_{ndc}=\frac{2}{r-l}x_{p}-\frac{r+l}{r-l} = \frac{\frac{2n}{r-l}x_{eye}-\frac{r+l}{r-l}z_{eye}}{-z_{eye}}

\\\\

\frac{y_{p}-b}{t-b}=\frac{y_{ndc}-(-1)}{1-(-1)} \Rightarrow  y_{ndc}=\frac{2}{t-b}y_{p}-\frac{t+b}{t-b} =  \frac{\frac{2n}{t-b}y_{eye}-\frac{t+b}{t-b}z_{eye}}{-z_{eye}}
