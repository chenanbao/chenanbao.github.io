...
| 类别 | Slua | ToLua | XLua |
| ------ | ------ | ------ | ------ |
| 工程结构、代码质量| ★★★☆☆ | ★★★★☆ 力求简洁 | ★★★★☆ 力求解耦、减少硬编码 |
| lib | luaprofile | cjson、pb、socket、lpeg、luaprofile、int64等  | luasocket、luaprofile、int64 。其他库[独立提供](https://github.com/chexiongsheng/build_xlua_with_libs) |
